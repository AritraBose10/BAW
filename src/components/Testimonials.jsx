            ...
            <div className="max-w-screen-xl mx-auto px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                    ...
                    <div className="test-card bg-white p-10 rounded-card border border-border-light shadow-subtle h-full flex flex-col justify-between">
                        ...
                        <div className="flex items-center gap-4 border-t border-border-light pt-6">
                            <img loading="lazy" alt="User" className="w-10 h-10 rounded-full object-cover grayscale" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDyAgxSMms8gRQELxK7OLKeKCitLfJX-Piy-y5aTvRCKT8rRFik50vwskTUEglYr0wyTBoihorNZ1I8yq9SF-mUgiz8UDBOaLW7UnG6XRZ-LHlv0mD7eCf2jn2MZk1Dnw5H86GG6KYnSsIKxfe1evOVAiSJe4UgVxb1BdpxHTqm2qpac_PZG5UFFZUv2xCzgboYFShRM9Eff_uK-AW7Wxs6B9-DHRw_8u3OHsCfJ6n97rNZh7VZGqon_3aPM4-E8Zmdw6s2pLI1Ikw" />
                            <div>
                    ...
                    <div className="test-card bg-white p-10 rounded-card border border-border-light shadow-subtle h-full flex flex-col justify-between">
                        ...
                        <div className="flex items-center gap-4 border-t border-border-light pt-6">
                            <img loading="lazy" alt="User" className="w-10 h-10 rounded-full object-cover grayscale" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCc-QoKdac51TOadhh6TQemOQTfPmNF9E7Nnmm8OVgZV8Ffo0UC7vJ01xLvwF-SskpYY26aty9jXsI7_QEVknJNWP77eTIypxc7eHAj_kxZGNb3YmOZBw0mD5GKzsLW1wJ8uG53tCno1WFL-NL-Kuw8hN5eMpu0Ijc2FXLO6ZPtbjmnLTi3kcVNKcNR2xSpaaY8d7KP9HbjSd49XZ1qYrit89CHLsP1U4-SdoA86v4s_AMVWMjM14GWc-F9MWnzvoWb8BX-dnxB7dQ" />
                            <div>
                ...
                <div className="mt-16 text-center">
                    ...
                    <div className="flex items-center justify-center gap-3 mt-4">
                        <div className="flex -space-x-2">
                            <img loading="lazy" alt="User" className="w-6 h-6 rounded-full border border-white object-cover grayscale" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDyAgxSMms8gRQELxK7OLKeKCitLfJX-Piy-y5aTvRCKT8rRFik50vwskTUEglYr0wyTBoihorNZ1I8yq9SF-mUgiz8UDBOaLW7UnG6XRZ-LHlv0mD7eCf2jn2MZk1Dnw5H86GG6KYnSsIKxfe1evOVAiSJe4UgVxb1BdpxHTqm2qpac_PZG5UFFZUv2xCzgboYFShRM9Eff_uK-AW7Wxs6B9-DHRw_8u3OHsCfJ6n97rNZh7VZGqon_3aPM4-E8Zmdw6s2pLI1Ikw" />
                            <img loading="lazy" alt="User" className="w-6 h-6 rounded-full border border-white object-cover grayscale" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCc-QoKdac51TOadhh6TQemOQTfPmNF9E7Nnmm8OVgZV8Ffo0UC7vJ01xLvwF-SskpYY26aty9jXsI7_QEVknJNWP77eTIypxc7eHAj_kxZGNb3YmOZBw0mD5GKzsLW1wJ8uG53tCno1WFL-NL-Kuw8hN5eMpu0Ijc2FXLO6ZPtbjmnLTi3kcVNKcNR2xSpaaY8d7KP9HbjSd49XZ1qYrit89CHLsP1U4-SdoA86v4s_AMVWMjM14GWc-F9MWnzvoWb8BX-dnxB7dQ" />
                            <img loading="lazy" alt="User" className="w-6 h-6 rounded-full border border-white object-cover grayscale" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCEgXmGkRtso73WadHqgopLk147RqJQwQZR1pd66edXwTGUDBXIVOdPmRT8_zAcb8yQW3rOtITkxPn_4H_zRJ8W80WKSgU74sXJ5a7ymAgbFGsHv4MRmpPDYV40WvPHXuwheypKgzxOvE429YjWIKYESS9pgiPjDDXAevvRh8GuabMf4R8MWlLbht_Ic2LMBh33aXJuIFbY_SPhIblnqIXoEFAamSvP4lrbnTgZryEV3bUW_hG_CerNUwSbU91b1EQ8GlkzQySoF-4" />
                        </div>
